...
class TestROS2Bridge(Node):
    def __init__(self):
        ...
        # Create the publisher to publish JointState messages to the "/joint_command_right_hand" topic
        self.publisher_ = self.create_publisher(JointState, "/right_arm_joint_states", 10)
        ...
        self.default_joints[0:7] = np.array([0.0, -0.785, 0.0, 0.524, 0.0, 1.300, 0.0])  # Arm joints
    ...
    def timer_callback(self):
        ...
        joint_position = (
            np.sin(time.time() - self.time_start) * 0.5 + self.default_joints
        )
